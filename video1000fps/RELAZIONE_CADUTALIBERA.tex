...
\begin{itemize}
    \itemsep0em 
        \item Posizione iniziale $y(0)$: \center{$K_0 = -0.0010852 \pm 0.000739$}  
         
            \small{(Non compatibile con il valore atteso $K_{0}$ $_{atteso}= 0.0000$)} 
         
    \end{itemize}
    \begin{itemize}
        \item Velocità iniziale $v(0)$: \center{$K_1 =  0.020001 \pm 0.0128$} 
        
        \small{(Non compatibile con il valore atteso $K_{1}$ $_{atteso} = 0.0000$)} 
        
    \end{itemize}
      \begin{itemize}
          \item Coefficiente del termine quadratico, pari a $\displaystyle{\frac{g}{2}}$:  \center{$K_2 =  4.9298 \pm 0.0353$}
